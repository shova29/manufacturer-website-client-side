      ...
      <footer className="footer px-10 py-4 border-t bg-neutral text-neutral-content border-base-300">
        ...
        <div className="md:place-self-center md:justify-self-end">
          <div className="grid grid-cols md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a>
              <FaGoogle className="w-5 h-full mx-auto hover:text-cyan-700" />
            </a>
            <a>
              <FaInstagram className="w-5 h-full mx-auto hover:text-cyan-700" />
            </a>
            <a>
              <FaLinkedin className="w-5 h-full mx-auto hover:text-cyan-700" />
            </a>
            <a>
              <FaTwitter className="w-5 h-full mx-auto hover:text-cyan-700" />
            </a>
            <a>
              <FaGithub className="w-5 h-full mx-auto hover:text-cyan-700" />
            </a>
          </div>
        </div>
      </footer>
